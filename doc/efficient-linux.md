...
- write something, which will traverse a through subdirs and read all files and find project wide duplicated lines (e.g. source "$RIBYN_ROOT/core/utils.sh" should accor often)
