...
"$RIBYN_ROOT/apps/wiremix/install.sh"
...
"$RIBYN_ROOT/apps/wayland/install-screenshot-tools.sh"
...
"$RIBYN_ROOT/apps/wayscriber/install.sh"

info "Installing dunst"
"$RIBYN_ROOT/apps/dunst/install.sh"

info "Installing mpvpaper"
"$RIBYN_ROOT/apps/mpvpaper/install.sh"

info "Installing wob"
"$RIBYN_ROOT/apps/wob/install.sh"

info "Installing i3"
"$RIBYN_ROOT/apps/i3/install.sh"
