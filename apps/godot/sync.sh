...
cp "$HOME/.config/godot/editor_settings-4.5.tres" "$RIBYN_ROOT/.backup/godot"
cp "$HOME/.config/godot/editor_settings-4.7.tres" "$RIBYN_ROOT/.backup/godot"

cp "$RIBYN_ROOT/apps/godot/config/editor_settings-4.5.tres" "$HOME/.config/godot/editor_settings-4.5.tres"
