...
vim.keymap.set("n", "<leader>go", ":DiffviewOpen<CR>", { desc = "git DiffviewOpen" })
vim.keymap.set("n", "<leader>gf", ":DiffviewFileHistory<CR>", { desc = "Git File History :DiffviewFileHistory" })
vim.keymap.set("n", "<leader>gb", ":DiffviewFileHistory %<CR>", { desc = "Git Buffer History :DiffviewFileHistory %" })
...
keymaps_ng = require("keymaps-angular")
vim.keymap.set("n", "<leader>at", function()
  keymaps_ng.open_angular_file(".ts")
end, vim.tbl_extend("force", { noremap = true, silent = true }, { desc = "Angular: Go to .ts" }))
vim.keymap.set("n", "<leader>ah", function()
  keymaps_ng.open_angular_file(".html")
end, vim.tbl_extend("force", { noremap = true, silent = true }, { desc = "Angular: Go to .html" }))
vim.keymap.set("n", "<leader>ac", function()
  keymaps_ng.open_angular_file(".scss")
end, vim.tbl_extend("force", { noremap = true, silent = true }, { desc = "Angular: Go to .scss/.css" }))
vim.keymap.set("n", "<leader>as", function()
  keymaps_ng.open_angular_file(".spec.ts")
end, vim.tbl_extend("force", { noremap = true, silent = true }, { desc = "Angular: Go to .spec.ts" }))
