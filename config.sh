...
# HYPRLAND
{
	...
	export RIBYN_HYPR_HYPRPOLKITAGENT_GIT_REF=${RIBYN_HYPR_HYPRPOLKITAGENT_GIT_REF:-"v0.1.3"}
	export RIBYN_HYPR_HYPRSHUTDOWN_GIT_REF=${RIBYN_HYPR_HYPRSHUTDOWN_GIT_REF:-"v0.1.1"}
	export RIBYN_HYPR_HYPRPAPER_GIT_REF=${RIBYN_HYPR_HYPRPAPER_GIT_REF:-"v0.8.4"}
	export RIBYN_HYPR_HYPRLOCK_GIT_REF=${RIBYN_HYPR_HYPRLOCK_GIT_REF:-"v0.9.6"}
	export RIBYN_HYPR_HYPRPICKER_GIT_REF=${RIBYN_HYPR_HYPRPICKER_GIT_REF:-"v0.4.7"}
