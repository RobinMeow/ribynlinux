return {
  {
    -- NOTE: alternative plugin: https://github.com/brenoprata10/nvim-highlight-colors
      ...
      options = {
        parsers = {
          ...
          hex = {
            ...
            rgb = true, -- #RGB (3-digit) #fff
            rgba = true, -- #RGBA (4-digit) #fff
            rrggbb = true, -- #RRGGBB (6-digit) #ffffff
            -- NOTE: change default false to true, I do use alphas
            rrggbbaa = true, -- #RRGGBBAA (8-digit) #ffffffff
